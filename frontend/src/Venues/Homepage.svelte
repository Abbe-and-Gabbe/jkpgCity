...
<body class="dark:bg-gray-900 pt-1 pb-3">
    ...
    <!--SECTION 1-->
    <section class="dark:bg-gray-900 grid gap-14 sm:grid-cols-12 m-14">

        <img src="img/jkpgcity1.jpg" alt="City of Jönköping" class="sm:col-span-4">

        <div class=" dark:bg-gray-900 sm:col-span-8 flex items-center justify-center p-10">
    ...
    <!--SECTION 3-->
    <section class="dark:bg-gray-900 flex items-center justify-center m-14">
        ...
        <div class="dark:bg-gray-900">
            ...
            <div class="dark:bg-gray-900 flex flex-wrap justify-center gap-10">
                   <!--Facebok-->
    ...
    <!--SECTION 4-->
        <div class="dark:bg-gray-900 flex items-center justify-center m-14">

            <div class="dark:bg-gray-900">

                <h2 class="dark:bg-gray-900 mb-6 text-3xl font-bold ">
                    JÖNKÖPING CITY
                </h2>
